...
class Info extends StatefulWidget {
  ...
  const Info({Key? key, this.patientModel}) : super(key: key);
...
class _InfoState extends State<Info> {
  ...
  void initState() {
    ...
    DOB.text =
        widget.patientModel!.dateOfBirth == null
                                    ...
                                    InkWell(
                                      onTap: () async {
                                        ...
                                        var body = jsonEncode({
                                          ...
                                          "faxNumber": "",
                                          "payments":
                                              widget.patientModel!.payments,
                                          "productViewModels":
                                              widget
                                                  .patientModel!
                                                  .productViewModels,
                                          "dieases":
                                              widget.patientModel!.dieases,
                                        });

                                        print(
                                          "editProfile request body::" + body,
                                        );
